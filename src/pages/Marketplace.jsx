...
const BANNER_SLIDES = [
  {
    ...
    img: brahman1,
    overlay:
      "linear-gradient(90deg, rgba(20,10,5,0.82) 0%, rgba(20,10,5,0.35) 60%, transparent 100%)",
  ...
  },
  {
    ...
    img: goat1,
    overlay:
      "linear-gradient(90deg, rgba(10,25,10,0.80) 0%, rgba(10,25,10,0.30) 60%, transparent 100%)",
  ...
  },
  {
    ...
    img: chicken1,
    overlay:
      "linear-gradient(90deg, rgba(60,30,5,0.82) 0%, rgba(60,30,5,0.35) 60%, transparent 100%)",
  ...
  },
  {
    ...
    img: pig1,
    overlay:
      "linear-gradient(90deg, rgba(15,15,40,0.82) 0%, rgba(15,15,40,0.35) 60%, transparent 100%)",
  ...
  },
  {
    ...
    img: all5,
    overlay:
      "linear-gradient(90deg, rgba(30,15,5,0.80) 0%, rgba(30,15,5,0.30) 60%, transparent 100%)",
    ...
    <div className="mp">
      ...
      <div className="mp-cats-wrap">
        <button
          ...
          onClick={() =>
            catScrollRef.current?.scrollBy({ left: -280, behavior: "smooth" })
          }
      ...
      <div className="mp-layout">
        ...
        <aside className={`mp-sidebar ${sidebarOpen ? "open" : ""}`}>
          ...
          >
            ...
            <p className="mp-ad-company">
              {BANNER_ADS[activeSidebarAd].company}
            </p>
            <p className="mp-ad-tagline">
              {BANNER_ADS[activeSidebarAd].tagline}
            </p>

            <a
              href={BANNER_ADS[activeSidebarAd].url}
              target="_blank"
            ...
            <div className="mp-recent-track">
              {recentlyViewed.map((l) => (
                ...
                >
                  ...
                  <p className="mp-recent-price">
                    USD {l.price?.toLocaleString()}
                  </p>
                </div>
              ))}
            </div>
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="mp-card-badges">
                        {isNew && (
                          <span className="mp-card-badge mp-badge-new">
                            🆕 New
                          </span>
                        )}
                        {isHot && (
                          <span className="mp-card-badge mp-badge-hot">
                            🔥 Hot
                          </span>
                        )}
                        {isSale && (
                          <span className="mp-card-badge mp-badge-sale">
                            Sale
                          </span>
                        )}
                        {!isNew && !isHot && !isSale && (
